...
# Logging
# -------------------------
logger = logging.getLogger("voice_shop_agent_master")
...
# -------------------------
# Simple Product Catalog (Mani Shop)
# -------------------------
...
class GameMasterAgent(Agent):
    def __init__(self):
        ...
        instructions = """
        You are 'Manish', the friendly shopkeeper and voice assistant for Mani Shop.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🛍️" * 6)
    logger.info("🚀 STARTING VOICE E-COMMERCE AGENT (Mani Shop) — Manish")
    ...
    # Start the agent session with the GameMasterAgent (manish)
    await session.start(
